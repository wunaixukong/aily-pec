...
class TodayWorkoutServiceTest {
    ...
    void setUp() {
        ...
        day1.setId(11L);
        day1.setDayOrder(1);
        day1.setContent("胸 + 三头");

        day2 = new WorkoutDay();
        day2.setId(12L);
        day2.setDayOrder(2);
        day2.setContent("背 + 二头");
    }
    ...
    void shouldReturnBaseDayWhenNoStatusDescription() {
        ...
        when(todayStatusRepository.findFirstByUserIdAndStatusDateOrderByCreateTimeDesc(eq(1L), any(LocalDate.class)))
                .thenReturn(Optional.empty());
        when(workoutRecommendationService.recommend(any(), eq(day1), eq(List.of(day1, day2)), eq(0)))
        ...
        when(todayWorkoutRecommendationRepository.save(any(TodayWorkoutRecommendation.class)))
                .thenAnswer(invocation -> {
                    TodayWorkoutRecommendation recommendation = invocation.getArgument(0);
    ...
    void shouldReuseRecommendationSnapshotOnSameDay() {
        ...
        verify(workoutRecommendationService, never()).recommend(any(), any(), any(), any(Integer.class));
    }
    ...
    void shouldAdvancePointerWhenRecommendedAlternativeCompleted() {
        ...
        recommendation.setRecommendationReason("今天更适合练背");
        ...
        when(workoutRecommendationService.findRecommendedDayById(List.of(day1, day2), day2.getId())).thenReturn(Optional.of(day2));
    ...
    void shouldReplaceTodayStatusAndClearUncompletedSnapshot() {
        ...
        assertTrue(result.isSuccess());
        verify(todayWorkoutRecommendationRepository).deleteByUserIdAndRecommendationDateAndCompletedFalse(eq(1L), any(LocalDate.class));
    }
    ...
    private void mockBaseContext() {
        ...
        when(workoutDayRepository.findByWorkoutPlanIdOrderByDayOrderAsc(activePlan.getId())).thenReturn(List.of(day1, day2));
    }
}
